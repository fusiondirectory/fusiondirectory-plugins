<table summary="">
 <tr>
  <td>
   <a href="plugins/fax/getfax.php?id={$detail}&amp;download=1">
     <img  align="bottom" width="420" height="594" src="plugins/fax/getfax.php?id={$detail}" alt="{t}FAX preview - please wait{/t}" border=1>
   </a>
