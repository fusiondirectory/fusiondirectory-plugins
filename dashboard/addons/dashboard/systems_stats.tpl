<div id="{$sectionId}" class="plugin_section">
  ...
  <div>
    ...
    {elseif $attributes.stats.argonaut.nb_servers == 1}
      {t 1=$attributes.stats.argonaut.server.cn 2=$attributes.stats.argonaut.server.ipHostNumber 3=$attributes.stats.argonaut.server.argonautProtocol 4=$attributes.stats.argonaut.server.argonautPort}There is an argonaut server running on %1 (%3://%2:%4){/t}<br/>
