<table style="width:100%;">
  <tr>
    ...
    <h2>{t}Heimdal REALM{/t}</h2>
    <table>
      <tr>
        <td>
          <label for="krb5PrincipalName">{t}krb5PrincipalName{/t}</label>
        </td>
        <td colspan="6">
          <input id="krb5PrincipalName" type="text" name="krb5PrincipalName" value="{$krb5PrincipalName}">@
          <select name="realm" id="realm" >   
            {html_options values=$liste_realm output=$liste_realm selected=$liste_realm}
          </select>
...
<input name="heimdalAccountTab" value="heimdalAccountTab" type="hidden"> 
