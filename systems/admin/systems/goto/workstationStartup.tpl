...
{/render}
  ...
  {elseif $fai_activated}
    ...
    {if $FAIdebianMirror == "inherited"}
      ...
      <table>
        <tr>
          <td>
            <h2><img class="center" alt="" align="middle" src="plugins/systems/images/fai_settings.png">&nbsp;{t}FAI server{/t}
            </h2>
          </td>
          <td>
            <h2><img class="center" alt="" align="middle" src="plugins/systems/images/fai_settings.png">&nbsp;{t}Release{/t}
            </h2>
          </td>
        </tr>
        <tr>
  ...
  {/render}
      ...
      <h2>
        <img class="center" alt="" align="middle" src="plugins/systems/images/fai_settings.png">&nbsp;{t}Assigned FAI profile{/t}
      </h2>
  ...
  {render acl=$FAIclassACL}
      <select name="FAIclass"  onchange='document.mainform.submit()'>
        {foreach from=$FAIprofiles item=val key=key}
          <option value="{$val}" {if $FAIclass == $val} selected {/if}>{$val}</option>
        {/foreach}
      </select> 
  {/render}
...
<table summary="" style="width:100%;">
 ...
 <tr>
  <td style="width:50%; vertical-align:top; border-right:1px solid #B0B0B0">
   <h2>
    <img class="center" alt="" align="middle" src="plugins/systems/images/hardware.png"> {t}Kernel modules (format: name parameters){/t}
   </h2>
...
{/render}
  ...
  <td style="vertical-align:top;">
        <h2><img class="center" alt="" src="plugins/systems/images/edit_share.png" align="middle">&nbsp;<LABEL for="gotoShare">{t}Shares{/t}</LABEL></h2>
        <table summary="" style="width:100%">
                <tr>
                        <td>
