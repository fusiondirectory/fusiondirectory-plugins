<table style="width:100%;" summary="">
 <tr>
  <td style="width:33%; vertical-align:top;">
   <h2><img class="center" alt="" align="middle" src="plugins/systems/images/keyboard.png"> {t}Keyboard{/t}</h2>
   <table summary="">
    <tr>
...
{/render}
  ...
  <td style="vertical-align:top;width:32%">
   <h2><img class="center" alt="" align="middle" src="plugins/systems/images/mouse.png"> {t}Mouse{/t}</h2>
   <table summary="">
    <tr>
...
<table style="width:100%;" summary="">
 ...
 <tr>
   <td style="width:33%;vertical-align:top;">
   <h2><img class="center" alt="" align="middle" src="plugins/systems/images/hardware.png"> {t}Graphic device{/t}</h2>
   <table summary="">
    <tr>
...
{/render}
  ...
  <td style="border-left:1px solid #A0A0A0">
   ...
   <h2><img class="center" alt="" align="middle" src="plugins/systems/images/display.png"> {t}Display device{/t}</h2>
   <table summary="">
    <tr>
     <td>{t}Type{/t}</td>
...
{/render}
  ...
  <td style="width:33%; vertical-align:top;">
   ...
   <h2><img class="center" alt="" align="middle" src="plugins/systems/images/scanner.png"> {t}Scan device{/t}</h2>
