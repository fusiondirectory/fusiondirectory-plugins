<h2><img class="center" alt="" src="plugins/systems/images/logon_script.png" align="middle">&nbsp;{t}Logon script management{/t}</h2>
  ...
  <table width="100%" summary="">
    <tr>
      <td colspan="2">
      <h2><img class="center" alt="" src="plugins/systems/images/logon_script.png" align="middle">&nbsp;{t}Script{/t}</h2>
