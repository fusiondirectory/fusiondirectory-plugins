...
<p class="plugbottom">
  <input type=submit name="add_memberNisnetgroups_finish" value="{msgPool type=addButton}">
  &nbsp;
  <input type=submit name="add_memberNisnetgroups_cancel" value="{msgPool type=cancelButton}">
</p>
